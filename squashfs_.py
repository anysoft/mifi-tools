...
def find_squashfs(filename):
    ...
    magic = '68 73 71 73 ** 01 00 00 ** ** ** 65 00 00 04 00 ** 00 00 00 04 00 12 00 C0 06 01 00 04 00 00 00 ** ** ** 07 00 00 00 00 ** ** ** 00 00 00 00 00 ** ** ** 00 00 00 00 00 FF FF FF FF FF FF FF FF'
